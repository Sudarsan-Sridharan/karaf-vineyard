 ...
 */
package org.apache.karaf.vineyard.registry.resource.rest.command.completer;
...
@Service
public class RestResourceIdCompleter implements Completer {
    ...
    public int complete(Session session, CommandLine commandLine, List<String> list) {
        ...
        resourceRegistryService
                .list()
                .stream()
                .map(resource -> delegate.getStrings().add(((RestResource) resource).getId()));
