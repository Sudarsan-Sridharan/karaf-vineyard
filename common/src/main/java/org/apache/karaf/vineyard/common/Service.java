...
public class Service {
    ...
    /** Define the scope of the service (on prem, cloud, dev environment, ...) */
    public String scope;
    ...
    /** The email service maintainers with corresponding roles */
    ...
    // TODO add policies (with the corresponding POJO)
